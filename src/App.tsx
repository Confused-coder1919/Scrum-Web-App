...
/**
 * Scrum Myths & Truths — Interactive Quiz App
 * -------------------------------------------------------
 * Features
 ...
 * - Lightweight in-repo UI primitives (button, card, tabs, etc.)
...
const QUESTION_BANK: QuizQuestion[] = [
  // 🔥 Mainstream Myths & Hard Truths (Scrum Guide 2020 aligned)
  // Roles & Power Myths
  {
    id: "Q1",
    category: "Roles",
  ...
  },
  {
    ...
    answer: false,
    hint: "Servant leader ≠ controller.",
    explanation:
  ...
  },
  {
    ...
    explanation:
      "Truth. Developers own the Daily Scrum. They inspect progress, adapt their plan, and decide the format—it's not a status meeting for the Scrum Master.",
  },
  {
    id: "Q4",
    category: "Roles",
  ...
  },
  {
    ...
    explanation:
      "Truth. Scrum Guide 2020 frames the Review as a conversation about outcomes, feedback, and next steps around the Increment—not a slide demo run in isolation.",
  },
  {
    id: "Q8",
    category: "Events",
  ...
  },
  {
    ...
    explanation:
      "Myth. Velocities are not comparable across teams—different contexts, backlogs, and scales. Compare outcomes, quality, and flow, not point totals.",
  },
  {
    id: "Q19",
    category: "Metrics",
    statement:
      "Scrum value includes outcomes like risk reduction, learning, compliance, and customer satisfaction—not only revenue.",
    answer: true,
  ...
  },
  {
    ...
    explanation:
      "Truth. Scrum’s cadence plus transparent metrics enable realistic projections; deterministic plans without feedback routinely mislead stakeholders.",
  },
  ...
  },
  {
    id: "Q39",
    category: "Remote",
    statement: "If we adopt the right agile tool, we’ll be doing Scrum.",
    answer: false,
    hint: "Tool ≠ process.",
    explanation:
...
function groupBy<T, K extends string | number>(xs: T[], key: (x: T) => K) {
  return xs.reduce<Record<K, T[]>>((acc, x) => {
    const k = key(x);
    (acc[k] ||= []).push(x);
    return acc;
  }, {} as any);
...
export default function ScrumMythsQuizApp() {
  ...
  const reviewCategories = Object.keys(grouped);
          ...
          <header className="mb-4 flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold tracking-tight">
                Scrum Myths & Truths — Interactive Quiz
              </h1>
            </div>
                  ...
                  {reviewMode && (
                    <div className="mt-4 rounded-xl border bg-white p-4">
                      ...
                      {reviewCategories.length ? (
                        <Tabs defaultValue={reviewCategories[0]}>
                        ...
                        <p className="text-sm text-slate-600">
                          Select at least one category to review its questions.
                        </p>
                      )}
                    </div>
                  )}
            ...
            <Card className="mb-6">
              <CardContent className="p-6">
                ...
                <div className="mb-3">
                  ...
                  <Input
                    placeholder="Write a short justification…"
                    value={justification}
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    title={`Costs ${penaltyHint} point. Use wisely!`}
                  >
                      ...
                      {answers.map((a, i) => {
                        ...
                        return (
                          <li key={q.id} className="rounded border p-2">
                            ...
                            <div className="text-xs text-slate-600">
                              Your justification:{" "}
                              {a.justification || <em>—</em>}
                            </div>
                            <div className="mt-1 text-xs">
                              Answer:{" "}
                              <strong>{q.answer ? "Truth" : "Myth"}</strong> —{" "}
                              {q.explanation}
                            </div>
                          </li>
                        );
